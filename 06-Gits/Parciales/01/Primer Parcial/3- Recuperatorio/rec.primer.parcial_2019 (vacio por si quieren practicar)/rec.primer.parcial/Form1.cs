...
namespace rec.primer.parcial
{
    public partial class Form1 : Form
    {
        ...
        //Si el objeto a comparar es un BancoNacional, mostrar mensaje y retornar true si los nombres son iguales
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show(bn.Equals(bn));
            MessageBox.Show(bn.Equals(bn2));
            MessageBox.Show(bn.Equals(bp));
            MessageBox.Show(bn.Equals(bm));
            MessageBox.Show(bn.Equals("hola, no soy un banco"));
