...
namespace SP
{
    ...
    public partial class SegundoParcial: Form
    {
        ...
        {
            MessageBox.Show("Abraldez Selene");
        }
        ...
        private void btnPunto5_Click(object sender, EventArgs e)
        {
            ...
            ManejadorTexto manejadora = new ManejadorTexto();
        ...
        private static bool AgregarFrutas(SegundoParcial frm)
        {
            ...
            try
            {
                ...
                comando.CommandText = "INSERT INTO sp_lab_II (nombre, peso, precio) values ('" + frm._manzana + "', '" + frm._manzana + "', " + frm._manzana + ")"; //se deberia agregar los valores chequeando que tipo de dato es al agregar y agregando uno por uno llamando por ejemplo, manzana.color etc
                //this._comando.CommandText = "INSERT INTO Padron.dbo.Personas (Nombre, apellido, edad) values ('" + p.nombre + "', '" + p.apellido + "', " + p.edad.ToString() + ")"; ejemplo de como habiamos hecho en clase con persona
                conexion.Open();
                retorno = true;
            }
            catch (Exception e)
